...
- On some distributions, you may need to disable the default route assigned to this adapter. The SSH network does not have routing capability.
...
1. Uncomment the line **_UseDNS yes_** and change it to **_UseDNS no_**, or add the line if you can't find it. This disables a reverse DNS lookup on terminal connect that can cause an up to 10 second delay.
